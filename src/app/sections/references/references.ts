/**
 * @fileoverview References component that displays testimonials and recommendations.
...
/**
 * References component responsible for displaying client testimonials and recommendations.
...
export class ReferencesComponent implements OnInit, OnDestroy, AfterViewInit {
   ...
   * Animation cycle: green for 0.5s, then default for 1s, repeating every 1.5s.
   */
  startTitleAnimation() {
   ...
   */
  setupArrowObserver() {
    const arrowElement = this.elementRef.nativeElement.querySelector('.references__arrow');
